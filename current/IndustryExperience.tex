...
\begin{entrylist}
	...
	\entry
		...
		{06/2017 -- 08/2017}
    		...
    		\noseplist{
    			\item Service aimed to reduce friction between internal and external development teams and to expedite the AVS Certification Process. \
    			\item textbf{Presented} design options and design document, \textbf{demonstrated} a working POC, and \textbf{transferred} ownership.
    		}
