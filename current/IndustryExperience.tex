...
\begin{entrylist}
	\entry
		 {10/2023 -- Present}
		 {PMT (Processes, Methods, and Testing)}
		 {\applied}
		 {Ensuring safety, quality, and speed.
		 \noseplist{
		 	\item \textbf{Implemented} new tests and features in our testing framework.
		 	\item \textbf{Designed} and \textbf{launched} new process to visualize and monitor integration tests.
		 	\item \textbf{Introduced} new logging framework and standards for logging and debugging. 
		 }
		 
		 \onelinelist{Python, AWS S3, AWS Cloudfront, AWS Lambda}
		 }
    \entry
         {03/2020 -- present}
	...
	\entry
		{08/2018 -- 04/2019}
    		...
    		\noseplist{
    			\item \textbf{Launched} product in new country.
				%  \textbf{implemented} core feature, \textbf{identified} blocking issues, and \textbf{resolved} them by working with our partner and \textbf{designing} a fall-back option.
